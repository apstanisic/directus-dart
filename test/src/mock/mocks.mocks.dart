...
import 'package:directus/src/modules/auth/_auth_storage.dart' as _i9;
import 'package:directus/src/modules/items/items_converter.dart' as _i3;
import 'package:directus/src/modules/items/items_handler.dart' as _i7;
...
class _FakeAuthFields_10 extends _i1.Fake implements _i5.AuthFields {}
...
class MockItemsHandler<T> extends _i1.Mock implements _i7.ItemsHandler<T> {
  ...
  set converter(_i3.ItemsConverter<dynamic>? _converter) =>
      super.noSuchMethod(Invocation.setter(#converter, _converter),
          returnValueForMissingStub: null);
  @override
  _i8.Future<_i4.DirectusResponse<T>> readOne(String? id,
          {_i4.OneQuery? query}) =>
  ...
  _i8.Future<_i4.DirectusListResponse<T>> readMany(
      ...
      (super.noSuchMethod(
          ...
          returnValue: Future<_i4.DirectusListResponse<T>>.value(
              _FakeDirectusListResponse_3<T>())) as _i8
          .Future<_i4.DirectusListResponse<T>>);
  @override
  ...
  @override
  _i8.Future<_i4.DirectusResponse<T>> updateOne({T? data, String? id}) => (super
      .noSuchMethod(Invocation.method(#updateOne, [], {#data: data, #id: id}),
          returnValue: Future<_i4.DirectusResponse<T>>.value(
              _FakeDirectusResponse_2<T>())) as _i8
...
class MockDio extends _i1.Mock implements _i2.Dio {
  ...
  void close({bool? force = false}) =>
      super.noSuchMethod(Invocation.method(#close, [], {#force: force}),
          returnValueForMissingStub: null);
  @override
  _i8.Future<_i2.Response<T>> get<T>(String? path,
  ...
  @override
  _i8.Future<_i2.Response<T>> getUri<T>(Uri? uri,
          {_i2.Options? options,
          _i2.CancelToken? cancelToken,
          _i2.ProgressCallback? onReceiveProgress}) =>
      (super.noSuchMethod(
          ...
          as _i8.Future<_i2.Response<T>>);
  @override
  _i8.Future<_i2.Response<T>> post<T>(String? path,
          {dynamic data,
          Map<String, dynamic>? queryParameters,
          _i2.Options? options,
          _i2.CancelToken? cancelToken,
      ...
      (super.noSuchMethod(
          ...
          as _i8.Future<_i2.Response<T>>);
  @override
  _i8.Future<_i2.Response<T>> postUri<T>(Uri? uri,
          {dynamic data,
          _i2.Options? options,
          _i2.CancelToken? cancelToken,
          _i2.ProgressCallback? onSendProgress,
      ...
      (super.noSuchMethod(
          ...
          as _i8.Future<_i2.Response<T>>);
  @override
  _i8.Future<_i2.Response<T>> put<T>(String? path,
          {dynamic data,
          Map<String, dynamic>? queryParameters,
          _i2.Options? options,
          _i2.CancelToken? cancelToken,
      ...
      (super.noSuchMethod(
          ...
          as _i8.Future<_i2.Response<T>>);
  @override
  _i8.Future<_i2.Response<T>> putUri<T>(Uri? uri,
          {dynamic data,
          _i2.Options? options,
          _i2.CancelToken? cancelToken,
          _i2.ProgressCallback? onSendProgress,
      ...
      (super.noSuchMethod(
          ...
          as _i8.Future<_i2.Response<T>>);
  @override
  _i8.Future<_i2.Response<T>> head<T>(String? path,
          {dynamic data,
          Map<String, dynamic>? queryParameters,
          _i2.Options? options,
          _i2.CancelToken? cancelToken}) =>
      (super.noSuchMethod(
          ...
          as _i8.Future<_i2.Response<T>>);
  @override
  _i8.Future<_i2.Response<T>> headUri<T>(Uri? uri,
      ...
      (super.noSuchMethod(
          ...
          as _i8.Future<_i2.Response<T>>);
  @override
  _i8.Future<_i2.Response<T>> delete<T>(String? path,
          {dynamic data,
          Map<String, dynamic>? queryParameters,
          _i2.Options? options,
          _i2.CancelToken? cancelToken}) =>
      (super.noSuchMethod(
          ...
          as _i8.Future<_i2.Response<T>>);
  @override
  _i8.Future<_i2.Response<T>> deleteUri<T>(Uri? uri,
          {dynamic data, _i2.Options? options, _i2.CancelToken? cancelToken}) =>
      (super.noSuchMethod(
          ...
          as _i8.Future<_i2.Response<T>>);
  @override
  _i8.Future<_i2.Response<T>> patch<T>(String? path,
          {dynamic data,
          Map<String, dynamic>? queryParameters,
          _i2.Options? options,
          _i2.CancelToken? cancelToken,
      ...
      (super.noSuchMethod(
          ...
          as _i8.Future<_i2.Response<T>>);
  @override
  _i8.Future<_i2.Response<T>> patchUri<T>(Uri? uri,
          {dynamic data,
          _i2.Options? options,
          _i2.CancelToken? cancelToken,
          _i2.ProgressCallback? onSendProgress,
  ...
  void clear() => super.noSuchMethod(Invocation.method(#clear, []),
      returnValueForMissingStub: null);
  @override
  _i8.Future<_i2.Response<dynamic>> download(String? urlPath, dynamic savePath,
          {_i2.ProgressCallback? onReceiveProgress,
          Map<String, dynamic>? queryParameters,
          _i2.CancelToken? cancelToken,
  ...
  @override
  _i8.Future<_i2.Response<dynamic>> downloadUri(Uri? uri, dynamic savePath,
          {_i2.ProgressCallback? onReceiveProgress,
          _i2.CancelToken? cancelToken,
          bool? deleteOnError = true,
          String? lengthHeader = r'content-length',
      ...
      (super.noSuchMethod(
          ...
          as _i8.Future<_i2.Response<dynamic>>);
  @override
  _i8.Future<_i2.Response<T>> request<T>(String? path,
          {dynamic data,
          Map<String, dynamic>? queryParameters,
          _i2.CancelToken? cancelToken,
          _i2.Options? options,
      ...
      (super.noSuchMethod(
          ...
          as _i8.Future<_i2.Response<T>>);
  @override
  _i8.Future<_i2.Response<T>> requestUri<T>(Uri? uri,
          {dynamic data,
          _i2.CancelToken? cancelToken,
          _i2.Options? options,
          _i2.ProgressCallback? onSendProgress,
...
class MockAuthStorage extends _i1.Mock implements _i9.AuthStorage {
  ...
  @override
  _i5.AuthFields get fields => (super.noSuchMethod(Invocation.getter(#fields),
      returnValue: _FakeAuthFields_10()) as _i5.AuthFields);
  @override
  _i8.Future<void> storeLoginData(_i10.AuthResponse? data) =>
      (super.noSuchMethod(Invocation.method(#storeLoginData, [data]),
          ...
          returnValueForMissingStub: Future<void>.value()) as _i8.Future<void>);
  @override
  _i8.Future<_i10.AuthResponse?> getLoginData() =>
      (super.noSuchMethod(Invocation.method(#getLoginData, []),
              returnValue: Future<_i10.AuthResponse?>.value())
